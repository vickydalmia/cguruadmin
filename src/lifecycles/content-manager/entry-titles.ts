...
// Single types whose Content Manager settings get a pinned mainField, so the
// admin breadcrumb/list shows a stable human title instead of the first
// attribute Strapi guesses.
