// Write-time enforcement of TEXT_FIELD_RULES (./text-field-rules): payload
// normalisation, blankness rules, offer-taxonomy relation checks, and the
// stored-read merge for partial payloads. Hint derivation lives in
// ./text-field-hints; both build on the same rule table so what is shown is
